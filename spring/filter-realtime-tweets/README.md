...
Follow the instruction in your console

The result will be written in the temp file 
You can get the name of that temp file in the log
At the same time the result will send to the the UI
